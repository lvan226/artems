...
$(function () {
  ...
  modalActive('.rati1', '#modal6');
  modalActive('.rati2', '#modal7');
  modalActive('.rati3', '#modal8');
  modalActive('.rati4', '#modal9');
  modalActive('.rati5', '#modal10');
  modalActive('.rati6', '#modal11');
    ...
    $(form).submit(function () { //Change
      ...
      $.ajax({
        ...
        if (flag == 1) {
          ...
          $(a).attr('href', '../Chek-list_-_Prodvizhenie_v_Sots_Setyakh.pdf');
          $(a)[0].click();
          $(modal).removeClass('active');
          $('.modal__overlay').detach();
          return;
